...
public class SingleProductController {
    ...
    private SportProductsService sportProductsService;
    private HomeProductsService homeProductsService;

    @Autowired
    public void setAllServices(ChildrenProductsService childrenProductsService, MenProductsService menProductsService,
