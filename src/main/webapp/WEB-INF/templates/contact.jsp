...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="<c:url value="/resource/static/vendors/jquery.form.js"/>"></script>
  <script src="<c:url value="/resource/static/vendors/jquery.validate.min.js"/>"></script>
  <script src="<c:url value="/resource/static/vendors/contact.js"/>"></script>
