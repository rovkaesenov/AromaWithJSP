			...
			<div class="container">
			    ...
			    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
				  <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
					...
					<li class="nav-item"><a class="nav-link" href="<c:url value="/rock/categories"/>">Shop Categories</a></li>
                      ...
                      <tbody>
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="<c:url value="/staticResources/static/img/cart/cart1.png"/>" alt="">
                                      </div>
                          ...
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="<c:url value="/staticResources/static/img/cart/cart2.png"/>" alt="">
                                      </div>
                                      <div class="media-body">
                                          <p>Minimalistic shop for multipurpose use</p>
                                      </div>
                          ...
                          <tr>
                              <td>
                                  <div class="media">
                                      <div class="d-flex">
                                          <img src="<c:url value="/staticResources/static/img/cart/cart3.png"/>" alt="">
                                      </div>
                                      <div class="media-body">
                                          <p>Minimalistic shop for multipurpose use</p>
                                      </div>
				...
				<div class="row section_gap">
					...
					<div class="offset-lg-1 col-lg-2 col-md-6 col-sm-6">
						<div class="single-footer-widget tp_widgets">
							...
							<ul class="list">
								<li><a th:href="@{/rock/index}">Home</a></li>
								<li><a href="#">Shop</a></li>
								<li><a th:href="@{/rock/blog}">Blog</a></li>
								<li><a href="#">Product</a></li>
								<li><a href="#">Brand</a></li>
								<li><a th:href="@{/rock/contact}">Contact</a></li>
							</ul>
						</div>
					</div>
