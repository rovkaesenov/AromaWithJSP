			...
			<div class="col-lg-6">
			    <div class="login_box_img">
				  <div class="hover">
					...
					<a class="button button-account" href="<c:url value="/rock/login"/>">Login Now</a>
				  </div>
			    </div>
			</div>
			<div class="col-lg-6">
			    <div class="login_form_inner register_form_inner">
				  ...
				  <form:form class="row login_form" action="/rock/postRegister" method="post" modelAttribute="user">
					<div class="col-md-12 form-group">
					    <form:input class="form-control" id="userName" placeholder="Username" path="userName"/>
					    <small><form:errors cssStyle="color: red;" path="userName" cssClass="errorMessage"/></small>
					</div>

					<div class="col-md-12 form-group">
					    <form:input class="form-control" id="email" path="email" placeholder="Email Address"/>
					    <small><form:errors cssStyle="color: red;" path="email" cssClass="errorMessage"/></small>
					</div>

					<div class="col-md-12 form-group">
					    <form:password class="form-control" path="password" id="password" placeholder="Password"/>
					    <small><form:errors cssStyle="color: red;" path="password" cssClass="errorMessage"/></small>
					</div>

					<div class="col-md-12 form-group">
					    <form:input type="text" class="form-control" id="confirmPassword" path="confirmPassword" placeholder="Confirm Password"/>
					    <small><form:errors cssStyle="color: red;" path="confirmPassword" cssClass="errorMessage"/></small>
					</div>
