			...
			<div class="row">
				<div class="col-xl-3 col-lg-4 col-md-5">
					<div class="sidebar-categories">
						<div class="head">Обзор категорий</div>
				...
				<div class="col-xl-9 col-lg-8 col-md-7">
					...
					<section class="lattest-product-area pb-40 category-list">
						<div class="row">
						    <c:if test="${childrenProductsList != null}">
							  <c:forEach var="childrenProduct" items="${childrenProductsList}">
								<div class="col-md-6 col-lg-4">
								    <div class="card text-center card-product">
									  <div class="card-product__img">
										<img class="card-img" src="/rock/category/displayChildren/<c:out value='${childrenProduct.id}'/>" alt="">
									  ...
									  <div class="card-body">
										<p>${childrenProduct.categoryChildren.subCategoryNames}</p>
										<h4 class="card-product__title"><a href="<c:url value="/rock/single-product/children?productId=${childrenProduct.id}"/>">${childrenProduct.productName}</a></h4>
										<p class="card-product__price">${childrenProduct.price}$</p>
									  </div>
								    </div>
								</div>
							  </c:forEach>
						    </c:if>
						    <c:if test="${menProductsList != null}">
							  <c:forEach var="menProduct" items="${menProductsList}">
								<div class="col-md-6 col-lg-4">
								    <div class="card text-center card-product">
									  <div class="card-product__img">
										<img class="card-img" src="/rock/category/displayMen/<c:out value='${menProduct.id}'/>" alt="">
										<ul class="card-product__imgOverlay">
										    <li><button><i class="ti-search"></i></button></li>
										    <li><button><i class="ti-shopping-cart"></i></button></li>
										    <li><button><i class="ti-heart"></i></button></li>
									  ...
									  <div class="card-body">
										<p>${menProduct.categoryForMen.subCategoryNames}</p>
										<h4 class="card-product__title"><a href="<c:url value="/rock/single-product/men?productId=${menProduct.id}"/>">${menProduct.productName}</a></h4>
										<p class="card-product__price">${menProduct.price}$</p>
									  </div>
								    </div>
								</div>
							  </c:forEach>
		...
		<div class="container">
			...
			<div class="row mt-30">
				<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
					<div class="single-search-product-wrapper">
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-1.png"/>" alt=""></a>
							<div class="desc">
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-2.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-3.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
				...
				<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
					<div class="single-search-product-wrapper">
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-4.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-5.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-6.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
				...
				<div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
					<div class="single-search-product-wrapper">
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-7.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-8.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
						...
						<div class="single-search-product d-flex">
							<a href="#"><img src="<c:url value="/resource/static/img/product/product-sm-9.png"/>" alt=""></a>
							<div class="desc">
								<a href="#" class="title">Gray Coffee Cup</a>
								<div class="price">$170.00</div>
							</div>
